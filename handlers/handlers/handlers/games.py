...
# Store active games to avoid collisions
active_trivia = {}
active_guess = {}
...
def register(bot: Client):
    ...
    async def trivia_callback(client: Client, query: CallbackQuery):
    ...
    @bot.on_callback_query()
    async def guess_callback(client: Client, query: CallbackQuery):
